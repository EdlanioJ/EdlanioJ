...
export const CssIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M7.502 0h2.578v1.078h-1.5v1.078h1.5v1.078H7.502V0ZM10.595 0h2.579v.938h-1.5v.187h1.5v2.156h-2.579v-.984h1.5v-.188h-1.5V0ZM13.69 0h2.577v.938h-1.5v.187h1.5v2.156H13.69v-.984h1.5v-.188h-1.5V0Z" />
    <path
      fillRule="evenodd"
